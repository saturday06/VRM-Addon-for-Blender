...
# This code is auto generated.
# To regenerate, run the `uv run tools/property_typing.py` command.
def save_vrma_export_error_message(
    execution_context: str = "EXEC_DEFAULT",
    /,
    *,
    filter_glob: str = "*.txt",
    ...
    return bpy.ops.vrm.save_vrma_export_error_message(  # type: ignore[attr-defined, no-any-return]
        execution_context,
        filter_glob=filter_glob,
...
def export_vrma(
    ...
    return bpy.ops.vrm.export_vrma(  # type: ignore[attr-defined, no-any-return]
        execution_context,
    )
