...
from .khr_character.property_group import KhrAvatarPropertyGroup
...
class VrmAddonArmatureExtensionPropertyGroup(PropertyGroup):
    ...
    SPEC_VERSION_KHR_AVATAR = "KHR_character"
    spec_version_items = (
    ...
    if TYPE_CHECKING:
        ...
        khr_character: KhrAvatarPropertyGroup  # type: ignore[no-redef]
