...
from .ops import (
    VRM_OT_add_khr_xmp_json_ld_khr_avatar_packet_dc_creator,
    VRM_OT_add_khr_xmp_json_ld_khr_avatar_packet_dc_license,
    VRM_OT_add_khr_xmp_json_ld_khr_avatar_packet_dc_subject,
    VRM_OT_move_down_khr_xmp_json_ld_khr_avatar_packet_dc_creator,
    VRM_OT_move_down_khr_xmp_json_ld_khr_avatar_packet_dc_license,
    VRM_OT_move_down_khr_xmp_json_ld_khr_avatar_packet_dc_subject,
    VRM_OT_move_up_khr_xmp_json_ld_khr_avatar_packet_dc_creator,
    VRM_OT_move_up_khr_xmp_json_ld_khr_avatar_packet_dc_license,
    VRM_OT_move_up_khr_xmp_json_ld_khr_avatar_packet_dc_subject,
    VRM_OT_remove_khr_xmp_json_ld_khr_avatar_packet_dc_creator,
    VRM_OT_remove_khr_xmp_json_ld_khr_avatar_packet_dc_license,
    VRM_OT_remove_khr_xmp_json_ld_khr_avatar_packet_dc_subject,
)
from .property_group import (
    KhrXmpJsonLdKhrAvatarPacketPropertyGroup,
)
from .ui_list import (
    VRM_UL_khr_xmp_json_ld_khr_avatar_packet_dc_creator,
    VRM_UL_khr_xmp_json_ld_khr_avatar_packet_dc_license,
    VRM_UL_khr_xmp_json_ld_khr_avatar_packet_dc_subject,
)

logger = get_logger(__name__)


def draw_khr_xmp_json_ld_khr_avatar_packet_layout(
    armature: Object,
    _context: Context,
    layout: UILayout,
    packet: KhrXmpJsonLdKhrAvatarPacketPropertyGroup,
) -> None:
