...
from .property_group import KhrXmpJsonLdKhrAvatarPacketPropertyGroup

logger = get_logger(__name__)


class VRM_UL_khr_xmp_json_ld_khr_avatar_packet_dc_creator(UIList):
    bl_idname = "VRM_UL_khr_xmp_json_ld_khr_avatar_packet_dc_creator"
    ...
    def draw_item(
        ...
        if not isinstance(packet, KhrXmpJsonLdKhrAvatarPacketPropertyGroup):
            return
...
class VRM_UL_khr_xmp_json_ld_khr_avatar_packet_dc_license(UIList):
    bl_idname = "VRM_UL_khr_xmp_json_ld_khr_avatar_packet_dc_license"
...
class VRM_UL_khr_xmp_json_ld_khr_avatar_packet_dc_subject(UIList):
    bl_idname = "VRM_UL_khr_xmp_json_ld_khr_avatar_packet_dc_subject"
