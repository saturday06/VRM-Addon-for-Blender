...
from .exporter import export_scene, vrm_animation_exporter_process
...
classes: list[
    ...
    vrm_animation_exporter_process.ExportProcessOutputLinePropertyGroup,
    vrm_animation_exporter_process.VRM_UL_vrma_export_process_output,
    vrm_animation_exporter_process.VRM_OT_save_vrma_export_error_message,
    vrm_animation_exporter_process.VRM_OT_export_vrma,
    vrm_animation_exporter_process.WM_OT_vrma_export_result,
