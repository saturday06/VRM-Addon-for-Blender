...
from .editor.khr_avatar import property_group as khr_avatar_property_group
...
classes: list[
    ...
    khr_xmp_json_ld_ops.VRM_OT_add_khr_xmp_json_ld_khr_avatar_packet_dc_creator,
    khr_xmp_json_ld_ops.VRM_OT_remove_khr_xmp_json_ld_khr_avatar_packet_dc_creator,
    khr_xmp_json_ld_ops.VRM_OT_move_up_khr_xmp_json_ld_khr_avatar_packet_dc_creator,
    khr_xmp_json_ld_ops.VRM_OT_move_down_khr_xmp_json_ld_khr_avatar_packet_dc_creator,
    khr_xmp_json_ld_ops.VRM_OT_add_khr_xmp_json_ld_khr_avatar_packet_dc_license,
    khr_xmp_json_ld_ops.VRM_OT_remove_khr_xmp_json_ld_khr_avatar_packet_dc_license,
    khr_xmp_json_ld_ops.VRM_OT_move_up_khr_xmp_json_ld_khr_avatar_packet_dc_license,
    khr_xmp_json_ld_ops.VRM_OT_move_down_khr_xmp_json_ld_khr_avatar_packet_dc_license,
    khr_xmp_json_ld_ops.VRM_OT_add_khr_xmp_json_ld_khr_avatar_packet_dc_subject,
    khr_xmp_json_ld_ops.VRM_OT_remove_khr_xmp_json_ld_khr_avatar_packet_dc_subject,
    khr_xmp_json_ld_ops.VRM_OT_move_up_khr_xmp_json_ld_khr_avatar_packet_dc_subject,
    khr_xmp_json_ld_ops.VRM_OT_move_down_khr_xmp_json_ld_khr_avatar_packet_dc_subject,
    khr_xmp_json_ld_property_group.KhrXmpJsonLdKhrAvatarPacketPropertyGroup,
    khr_xmp_json_ld_ui_list.VRM_UL_khr_xmp_json_ld_khr_avatar_packet_dc_creator,
    khr_xmp_json_ld_ui_list.VRM_UL_khr_xmp_json_ld_khr_avatar_packet_dc_license,
    khr_xmp_json_ld_ui_list.VRM_UL_khr_xmp_json_ld_khr_avatar_packet_dc_subject,
    khr_avatar_property_group.KhrAvatarPropertyGroup,
