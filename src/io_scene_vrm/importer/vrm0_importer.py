...
class Vrm0Importer(AbstractBaseVrmImporter):
    ...
    def assign_mtoon0_property(
        ...
        if base_color_factor:
            gltf.pbr_metallic_roughness.base_color_factor = convert.linear_to_srgb(
                base_color_factor
            )
        ...
        if shade_color_factor:
            mtoon.shade_color_factor = convert.linear_to_srgb(shade_color_factor)
        ...
        if max_color_component_value > 1:
            gltf.emissive_factor = convert.linear_to_srgb(
            ...
            gltf.emissive_factor = convert.linear_to_srgb(raw_emissive_factor)
        ...
        if parametric_rim_color_factor:
            mtoon.parametric_rim_color_factor = convert.linear_to_srgb(
        ...
        if outline_color_factor:
            mtoon.outline_color_factor = convert.linear_to_srgb(outline_color_factor)
