...
VRM Add-on for
Blenderは、BlenderにVRMのインポート、エクスポートや編集機能を追加するアドオンです。バージョン2.93から5.0のBlenderに対応しています。

## ダウンロード {#download}

- Blender
  4.2以上をお使いの場合、[こちらのインストール手順](installation/)に従い、Blenderの設定画面からインストールをお願いします。
