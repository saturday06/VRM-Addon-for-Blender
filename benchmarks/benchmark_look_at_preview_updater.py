...
from io_scene_vrm.editor.vrm1.handler import LookAtPreviewUpdater
...
def benchmark_look_at_preview_updater(context: Context) -> None:
...
if __name__ == "__main__":
    benchmark_look_at_preview_updater(bpy.context)
