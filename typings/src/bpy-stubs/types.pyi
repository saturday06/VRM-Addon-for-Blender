...
class bpy_struct:
    ...
    def path_resolve(self, path: str, coerce: bool = True, /) -> object: ...
    def keyframe_insert(
        self,
        data_path: str,
        index: int = -1,
...
class DepsgraphObjectInstance(bpy_struct):
    ...
    @property
    def orco(self) -> Vector: ...
    @property
    def parent(self) -> Object | None: ...
    @property
    def particle_system(self) -> ParticleSystem | None: ...
    @property
    def persistent_id(self) -> Sequence[int]: ...
    @property
    ...
    @property
    def uv(self) -> Sequence[float]: ...

class DepsgraphUpdate(bpy_struct):
    def id(self) -> ID: ...
    def is_updated_geometry(self) -> bool: ...
    def is_updated_shading(self) -> bool: ...
    def is_updated_transform(self) -> bool: ...

class Depsgraph(bpy_struct):
    @property
    def ids(self) -> bpy_prop_collection[ID]: ...
    @property
    def mode(self) -> str: ...
    @property
    def object_instances(self) -> bpy_prop_collection[DepsgraphObjectInstance]: ...
    @property
    def objects(self) -> bpy_prop_collection[Object]: ...
    @property
    def scene(self) -> Scene: ...
    @property
    def scene_eval(self) -> Scene: ...
    @property
    def updates(self) -> bpy_prop_collection[DepsgraphUpdate]: ...
    @property
    def view_layer(self) -> ViewLayer: ...
    @property
    def view_layer_eval(self) -> ViewLayer: ...
...
class Object(ID):
    ...
    def to_mesh(
        ...
        # The sample code suggests that it returns None.
        # https://projects.blender.org/blender/blender/src/tag/v4.5.3/doc/python_api/examples/bpy.types.Depsgraph.6.py#L27-L30
        Mesh | None
    ): ...
...
class NodesModifierProperties(bpy_struct): ...
...
class NodesModifier(Modifier):
    ...
    @property
    def properties(self) -> NodesModifierProperties | None: ...
