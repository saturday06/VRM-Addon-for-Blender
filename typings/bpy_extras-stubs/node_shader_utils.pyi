...
class ShaderWrapper:
    ...
    is_readonly: bool
    material: Material
    node_out: ShaderNodeOutputMaterial | None
    ...
    def node_texcoords_get(self) -> ShaderNodeTexCoord | None: ...
    @property
    def node_texcoords(self) -> ShaderNodeTexCoord | None: ...
...
class PrincipledBSDFWrapper(ShaderWrapper):
    ...
    node_principled_bsdf: ShaderNodeBsdfPrincipled | None
    ...
    def node_normalmap_get(self) -> ShaderNodeNormalMap | None: ...
    @property
    def node_normalmap(self) -> ShaderNodeNormalMap | None: ...
    ...
    def base_color_texture_get(self) -> ShaderImageTextureWrapper | None: ...
    @property
    def base_color_texture(self) -> ShaderImageTextureWrapper | None: ...
    ...
    def specular_texture_get(self) -> ShaderImageTextureWrapper | None: ...
    @property
    def specular_texture(self) -> ShaderImageTextureWrapper | None: ...
    ...
    def roughness_texture_get(self) -> ShaderImageTextureWrapper | None: ...
    @property
    def roughness_texture(self) -> ShaderImageTextureWrapper | None: ...
    ...
    def metallic_texture_get(self) -> ShaderImageTextureWrapper | None: ...
    @property
    def metallic_texture(self) -> ShaderImageTextureWrapper | None: ...
    ...
    def ior_texture_get(self) -> ShaderImageTextureWrapper | None: ...
    @property
    def ior_texture(self) -> ShaderImageTextureWrapper | None: ...
    ...
    def transmission_texture_get(self) -> ShaderImageTextureWrapper | None: ...
    @property
    def transmission_texture(self) -> ShaderImageTextureWrapper | None: ...
    ...
    def alpha_texture_get(self) -> ShaderImageTextureWrapper | None: ...
    @property
    def alpha_texture(self) -> ShaderImageTextureWrapper | None: ...
    ...
    def emission_color_texture_get(self) -> ShaderImageTextureWrapper | None: ...
    @property
    def emission_color_texture(self) -> ShaderImageTextureWrapper | None: ...
    ...
    def emission_strength_texture_get(self) -> ShaderImageTextureWrapper | None: ...
    @property
    def emission_strength_texture(self) -> ShaderImageTextureWrapper | None: ...
    ...
    def normalmap_texture_get(self) -> ShaderImageTextureWrapper | None: ...
    @property
    def normalmap_texture(self) -> ShaderImageTextureWrapper | None: ...
...
class ShaderImageTextureWrapper:
    ...
    def node_image_get(self) -> ShaderNodeTexImage | None: ...
    @property
    def node_image(self) -> ShaderNodeTexImage | None: ...
    ...
    def node_mapping_get(self) -> ShaderNodeMapping | None: ...
    @property
    def node_mapping(self) -> ShaderNodeMapping | None: ...
