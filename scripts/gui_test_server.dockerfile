...
RUN mkdir noVNC \
    && cd noVNC \
    && curl -LSf --retry 5 https://github.com/novnc/noVNC/archive/cdfb33665195eb9a73fb00feb6ebaccd1068cd50.tar.gz | tar zxf - --strip-component 1
...
RUN mkdir noVNC/utils/websockify \
    ...
    && curl -LSf --retry 5 https://github.com/novnc/websockify/archive/33910d758d2c495dd1d380729c31bacbf8229ed0.tar.gz | tar zxf - --strip-component 1
