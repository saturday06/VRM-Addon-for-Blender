...
if [ "$(uname -m)" = "aarch64" ] && ! java -jar sikulixide.jar -c -r tests/test.sikuli; then
  rm /home/developer/.Sikulix/SikulixLibs/libopencv_java430.so
  ln -s /usr/lib/jni/libopencv_java451.so /home/developer/.Sikulix/SikulixLibs/libopencv_java430.so
  rm /home/developer/.Sikulix/SikulixLibs/libJXGrabKey.so
  ln -s /usr/lib/aarch64-linux-gnu/jni/libJXGrabKey.so /home/developer/.Sikulix/SikulixLibs/libJXGrabKey.so
fi
