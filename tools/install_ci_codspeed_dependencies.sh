...
mkdir -p "${HOME}/OpenImageIO/src"
cd "${HOME}/OpenImageIO/src"
...
make NPROCS=1 "BUILD_CMAKE_ARGS=-DPYTHON_VERSION=3.12 -DWITH_VULKAN_BACKEND=OFF '-DCMAKE_INCLUDE_PATH=${numpy_include_path}'" bpy
sudo ldconfig
