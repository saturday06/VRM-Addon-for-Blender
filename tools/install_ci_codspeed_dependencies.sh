...
export C_INCLUDE_PATH=/opt/vrm/include
export CPLUS_INCLUDE_PATH=/opt/vrm/include
export LD_LIBRARY_PATH=/opt/vrm/lib
...
export PYTHONPATH="${repository_root_path}/src:/opt/vrm/lib/python3.12/site-packages"
mkdir -p "$PYTHONPATH"
cp -r ../build_linux_bpy/bin/* "$PYTHONPATH"
ldconfig
