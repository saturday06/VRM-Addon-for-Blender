...
from io_scene_vrm.common.human_bone_mapper import structure_based_mapping
...
Tree = Mapping[tuple[Union[str, HumanBoneName], tuple[float, float, float]], "Tree"]
...
class TestStructureBasedMapper(AddonTestCase):
    def assert_tree(self, tree: Tree, what: str) -> None:
        context = bpy.context
        ...
        actual_mapping = structure_based_mapping.create_structure_based_mapping(
            armature
        )
